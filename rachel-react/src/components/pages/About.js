...
export default class About extends Component {
    ...
    renderAccreditations = () => {
        const accreditations = [
            {
                ...
                url:        'https://www.learnacademy.org/curriculum?learn_class=9'
            },
            {
                image:      'pmp.png',
                year:       '2017',
        ...
        return (
            <div id='accreditations'>
                <h2 className="small-heading">ACCREDITATIONS</h2>
                <div id='facts-wrapper'>
                {accreditations.map(accreditation => {
                    const {image, year, caption, url} = accreditation;
                    return (
                        <div className='facts' key={image}>
    ...
    renderHeader = () => <h2 className="small-heading">Rachel Ruderman</h2>;
